...
enum class CalendarFeatureFlag(val featureId: FeatureId, val fallbackValue: Boolean, val isLocalFlag: Boolean) {
    ...
    ProtonMeetAddManual(FeatureId("CalendarAndroidProtonMeetAdd"), false, false),
    ProtonMeetAddAuto(FeatureId("CalendarAndroidAutoAddMeetingLink"), false, false),
    ...
    LogsExport(FeatureId("CalendarAndroidLogsExport"), false, false),
    DisableAlternativeRouting(FeatureId("DisableAlternativeRouting"), false, false),
