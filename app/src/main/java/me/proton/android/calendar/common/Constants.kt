...
val SPOTLIGHT_VERSION_CODES = arrayListOf(
    ...
    128 // Rebranding (0.32.3) // TODO Use correct version number
)
...
val windowsTimeZoneMap: Map<String, String> = mapOf(
    ...
    "phoenix islands" to "Pacific/Enderbury",
    ...
    "coordinated universal time+13" to "Pacific/Enderbury",
