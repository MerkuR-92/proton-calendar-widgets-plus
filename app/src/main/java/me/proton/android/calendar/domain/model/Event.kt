...
//        val dateTimeStamp: String
    ...
    fun generateOccurrencesUntilOrCount(timeZoneId: String, toDate: LocalDate?, occurrenceCount: Int?): List<Occurrence>? {
        ...
        while (startIterator.hasNext()) {
            ...
            } else if (!hasTime && !isAllDay()) ZonedDateTime.ofInstant(startIteratorNextInstant, ZoneId.of(timeZoneId)).withHour(startZonedDateTime.hour).withMinute(startZonedDateTime.minute)
            ...
            if (this.iCalEvent.summary?.value == "Hhh") {
                TimberLogger.v("Bug duplicated: Hhh occurrences ${occurrences.size}")
            }
