...
object PlanModule {
    ...
    fun provideSupportSignupPaidPlans() = CalendarFeatureFlag.Subscription.defaultLocalValue

    @Provides
    @SupportUpgradePaidPlans
    fun provideSupportUpgradePaidPlans() = CalendarFeatureFlag.Subscription.defaultLocalValue
