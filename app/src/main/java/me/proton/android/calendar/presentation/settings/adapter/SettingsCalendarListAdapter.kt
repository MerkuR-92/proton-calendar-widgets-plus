...
class SettingsCalendarListAdapter(
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(calendar : Calendar) {
            ...
            calendarItemMenuIcon.visibleOrGone((calendar.isSubscribed.not() && calendar.allowEditCalendar) || (calendar.isSubscribed && FeatureFlag.ALARMS_IN_SUBSCRIBED_CALENDARS))

            // Only allow item click when calendar can be edited
            calendarItemPress.visibleOrGone((calendar.isSubscribed.not() && calendar.allowEditCalendar) || (calendar.isSubscribed && FeatureFlag.ALARMS_IN_SUBSCRIBED_CALENDARS))

            if ((calendar.isSubscribed.not() && calendar.allowEditCalendar) || (calendar.isSubscribed && FeatureFlag.ALARMS_IN_SUBSCRIBED_CALENDARS)) {
                // On item click
