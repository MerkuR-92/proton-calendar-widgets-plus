...
data class CalendarSubscriptionEntity(
    ...
    // Calendar is in sync if status is 0 and has been updated in the last 24 hours
    val isSynced: Boolean get() = status == 0 || ((System.currentTimeMillis() / 1000) - lastUpdateTime < Duration.ofHours(24).toMinutes() * 60)
}