...
class ValueStoreProviderImpl(private val sharedPreferencesProvider: SharedPreferencesProvider) : ValueStoreProvider {
    ...
    inner class ValueStoreImpl(private val sharedPreferences: SharedPreferences) : ValueStore {
        ...
        @Synchronized
        override fun putStringInSet(setName: String, key: String, value: String) = sharedPreferences.edit().putString("$setName~$key", value).apply()
        @Synchronized
        override fun getStringFromSet(setName: String, key: String): String? = sharedPreferences.getString("$setName~$key", null)
    }
...
class SharedPreferencesProvider(private val applicationContext: Context) {
    ...
    // key alias for EncryptedSharedPreferences, generated by androidx library
